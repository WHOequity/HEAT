...
-------------------------------------------------------------------------------
WHO HEALTH EQUITY ASSESSMENT TOOLKIT PLUS (HEAT PLUS), DESKTOP VERSION

The WHO Health Equity Assessment Toolkit is a software application that 
facilitates the assessment of health inequalities. Inequalities can be 
assessed through disaggregated data and summary measures of health inequality,
visualized in interactive graphs, maps and tables. Results can be exported and
...
For further information about HEAT and HEAT Plus, please refer to the WHO 
website: https://www.who.int/data/inequality-monitor/assessment_toolkit

This desktop version contains: HEAT Plus, version 6.0, and supporting software.

-------------------------------------------------------------------------------
DISCLAIMER

© Copyright World Health Organization, 2016-2024. 
...
In order to run HEAT Plus on your device, you require the “R” statistical software
and a web browser. In the desktop version of the Toolkit, WHO has provided a 
portable version of “R” and the portable edition of the web browser Google Chrome.
This does not imply in any manner that the use of these products are endorsed or 
recommended by the World Health Organization in preference to others of a similar 
nature. R Portable and Chrome Portable do not require any installation.

To run HEAT Plus on your Windows machine, download the compressed 
"HEAT Plus for Windows" (zip) file, unzip the file and save the content to your 
computer's hard drive. Select the “HEAT Plus for Windows” folder and double-click
the “Start_HEATPlus.bat” file. The toolkit will automatically open in a Chrome 
Portable browser window.

To refresh the software, click the circular arrow on the right of the address 
bar in the open browser window. To restart the software, make sure to close both
the browser window and the command window, before double-clicking the 
“Start_HEATPlus.bat” file.
...
or will, make two editions of the Toolkit available:
  ...
  (i) HEAT, the built-in database edition, which includes data, originating 
from the WHO Health Inequality Data Repository, for use with the Software 
...
Organization, 2016-2024, and is distributed under the terms of version 3 of the 
...
Data Repository. Except where otherwise indicated, Data is © WHO. Please refer
to the Indicator Metadata for more information about the source of the Data.
...
health inequalities in countries. Built-in database edition. Version 6.0. 
